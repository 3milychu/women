...
vizuly.viz.linearea_mobile = function (parent) {
    ...
    var properties = {
        ...
        "layout" :                              // Sets a STACKED or OVERLAP layout
    ...
    var viz=vizuly.core.component(parent,scope,properties,["pointerdrag"]);
    ...
    function measure() {
        ...
        if (scope.xScale == "undefined") {
            scope.xScale=vizuly.core.util.getTypedScale(viz.x()(scope.data[0][0]));
        }
