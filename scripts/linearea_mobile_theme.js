...
vizuly.theme.linearea_mobile = function (viz) {
    ...
    function applyTheme() {
        ...
        selection.selectAll(".vz-plot-background")
        .style("background-color","white")
        .style("opacity", 0);

        selection.selectAll(".vz-index-line")
            .style("stroke-width",(w/4 * 0.004)+"px")
            .style("stroke-dasharray",[w/4 *.01,w *.007])
            .style("stroke","#ED7D31")
    ...
    function onMeasure() {
        var size = vizuly.core.util.size(viz.margin(), viz.width(), viz.height());
    ...
    var colors=["#ffffff","#FFAF49","#7986CB","#2DA4A9","#E57373"];
    var gradients=["#E6E6E6","#FF653A","#2D4FAC","#3F5874","#C62828"];
